...
class EmailDeleteActivity : AppCompatActivity() {
    private lateinit var actionReturn: TextView
    private lateinit var actionCancel: Button
    private lateinit var actionExecute: Button

    private lateinit var fieldRegister: TextView
    private lateinit var fieldParam: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.model_email_delete)
    ...
    private fun showRegister() {
        ...
        fieldParam.text = current.param ?: ""
        fieldValue.text = getSafeValue(current)
    }
