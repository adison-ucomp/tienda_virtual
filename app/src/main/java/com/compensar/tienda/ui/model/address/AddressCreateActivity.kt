...
class AddressCreateActivity : AppCompatActivity() {
    ...
    private fun initViews(){ titleHeader=findViewById(R.id.titleHeader); actionHome=findViewById(R.id.actionHome); actionReturn=findViewById(R.id.actionReturn); actionCancel=findViewById(R.id.actionCancel); actionExecute=findViewById(R.id.actionExecute); ModuleView.bindTitle(titleHeader, "Crear", "address", "Direcciones"); fieldAddress=findViewById(R.id.fieldAddress); fieldLabel=findViewById(R.id.fieldLabel); fieldIdUser=findViewById(R.id.fieldIdUser); fieldIdUbication=findViewById(R.id.fieldIdUbication) }
