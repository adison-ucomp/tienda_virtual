...
class ShopUpdateActivity : AppCompatActivity() {
    ...
    private lateinit var fieldIdSeller: EditText
    ...
    private fun showRegister() {
        ...
        fieldIdSeller.setText(current.idSeller.toString())
    }
    ...
    private fun actionOperate() {
        ...
        val updatedData = ShopModel(
            register = register,
            name = fieldName.text.toString().trim().ifEmpty { null },
            idSeller = fieldIdSeller.text.toString().trim().toLongOrNull() ?: 0
        )
