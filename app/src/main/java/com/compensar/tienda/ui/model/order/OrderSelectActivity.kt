...
class OrderSelectActivity : AppCompatActivity() {
    ...
    private fun loadCard(data: OrderModel): CardView {
        ...
        val tradeLabel = addText(textContainer, "Transacción: Cargando...")
        FirestoreRelationLabelHelper.load(tradeLabel, "trade", data.idTrade, listOf("state", "register"))
        ...
        val paymentLabel = addText(textContainer, "Método de pago: Cargando...")
        FirestoreRelationLabelHelper.load(paymentLabel, "payment", data.idPayment, listOf("name"))
