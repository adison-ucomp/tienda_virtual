...
class AddressUpdateActivity : AppCompatActivity() {
    ...
    private fun initViews(){ titleHeader=findViewById(R.id.titleHeader); actionHome=findViewById(R.id.actionHome); actionReturn=findViewById(R.id.actionReturn); actionCancel=findViewById(R.id.actionCancel); actionExecute=findViewById(R.id.actionExecute); ModuleView.bindTitle(titleHeader, "Actualizar", "address", "Direcciones"); fieldAddress=findViewById(R.id.fieldAddress); fieldLabel=findViewById(R.id.fieldLabel); fieldIdUser=findViewById(R.id.fieldIdUser); fieldIdUbication=findViewById(R.id.fieldIdUbication) }
    private fun initEvents(){ actionHome.setOnClickListener{startActivity(Intent(this,AdminDashboardActivity::class.java));finish()}; actionReturn.setOnClickListener{finish()}; actionCancel.setOnClickListener{finish()}; actionExecute.setOnClickListener{actionOperate()} }
