...
class AddressSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionNew.setOnClickListener {
            val intent = Intent(this, AddressCreateActivity::class.java)
        ...
        collection
            ...
            .addOnSuccessListener { result ->
                ...
                val items = result.documents.mapNotNull { document ->
                    document.toObject(AddressModel::class.java)
    ...
    private fun loadCard(data: AddressModel): CardView {
        ...
        val btnEdit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@AddressSelectActivity, AddressUpdateActivity::class.java)
        ...
        val btnQuit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@AddressSelectActivity, AddressDeleteActivity::class.java)
                intent.putExtra("register", data.register)
                startActivity(intent)
            }
        }
