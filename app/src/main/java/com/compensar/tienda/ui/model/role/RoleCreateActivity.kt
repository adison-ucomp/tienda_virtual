...
class RoleCreateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.model_role_create)
    ...
    private fun initViews() {
        ...
        ModuleView.bindTitle(titleHeader, "Crear", "role", "Roles")
    ...
    private fun saveRegister(data: RoleModel) {
