...
class RoleSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.model_role_select)
        ...
        actionNew.setOnClickListener {
            val intent = Intent(this, RoleCreateActivity::class.java)
    ...
    private fun loadCard(data: RoleModel): CardView {
        ...
        val btnEdit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@RoleSelectActivity, RoleUpdateActivity::class.java)
        ...
        val btnQuit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@RoleSelectActivity, RoleDeleteActivity::class.java)
                intent.putExtra("register", data.register)
                startActivity(intent)
            }
        }
