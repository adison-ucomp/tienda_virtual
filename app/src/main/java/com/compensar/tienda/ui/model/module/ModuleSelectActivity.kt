...
class ModuleSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.model_module_select)
        ...
        actionNew.setOnClickListener {
            val intent = Intent(this, ModuleCreateActivity::class.java)
    ...
    private fun loadCard(data: ModuleModel): CardView {
        ...
        val txtModel = TextView(this).apply {
            text = "Modelo: ${data.model ?: ""}"
            textSize = 14f
            setTextColor(getColor(R.color.black))
            setPadding(0, dp(6), 0, 0)
        }
        textContainer.addView(txtModel)

        val txtState = TextView(this).apply {
            text = "Estado: ${if (data.state == false) "Apagado" else "Activo"}"
            textSize = 14f
            setTextColor(getColor(R.color.black))
            setPadding(0, dp(6), 0, 0)
        }
        textContainer.addView(txtState)
        ...
        val btnEdit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@ModuleSelectActivity, ModuleUpdateActivity::class.java)
        ...
        val btnQuit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@ModuleSelectActivity, ModuleDeleteActivity::class.java)
                intent.putExtra("register", data.register)
                startActivity(intent)
            }
        }
