...
class AddressDeleteActivity : AppCompatActivity() {
    ...
    private fun initViews(){ actionReturn=findViewById(R.id.actionReturn); actionCancel=findViewById(R.id.actionCancel); actionExecute=findViewById(R.id.actionExecute); fieldRegister=findViewById(R.id.fieldRegister); fieldAddress=findViewById(R.id.fieldAddress); fieldLabel=findViewById(R.id.fieldLabel) }
