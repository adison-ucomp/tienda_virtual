...
/**
 * Clase [SellerShopQuitActivity].
 *
 * Responsable de la logica asociada al pantalla del flujo de vendedor.
 */
class SellerShopQuitActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.seller_shop_quit)
    ...
    private fun actionOperate() {
        ...
        db.collection("product")
            .whereEqualTo("idShop", register)
            .limit(1)
            .get()
            .addOnSuccessListener { result ->
                if (!result.isEmpty) {
                    Toast.makeText(this, "No se puede eliminar porque la tienda tiene productos relacionados", Toast.LENGTH_LONG).show()
