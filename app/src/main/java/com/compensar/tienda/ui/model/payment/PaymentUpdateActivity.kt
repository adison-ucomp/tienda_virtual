...
class PaymentUpdateActivity : AppCompatActivity() {
    ...
    private var data: PaymentModel? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.model_payment_update)
    ...
    private fun initViews() {
        ...
        ModuleView.bindTitle(titleHeader, "Actualizar", "payment", "Pagos")
    ...
    private fun loadRegister() {
        ...
        collection.document(register.toString())
            ...
            .addOnSuccessListener { document ->
                if (document.exists()) {
                    data = document.toObject(PaymentModel::class.java)
                    showRegister()
                } else {
