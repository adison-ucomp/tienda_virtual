...
/**
 * Clase [SellerProductStoreActivity].
 *
 * Responsable de la logica asociada al pantalla del flujo de vendedor.
 */
class SellerProductStoreActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        titleHeader.text = "Crear Productos"
        ...
        db.collection("seller")
            ...
            .addOnSuccessListener { result ->
                ...
                FirestoreSelectHelper.load(
                    ...
                    filterField = "idSeller",
                    filterValue = sellerRegister
                )
            }
            .addOnFailureListener { exception ->
                exception.printStackTrace()
                Toast.makeText(this, "Error al cargar tiendas del vendedor", Toast.LENGTH_SHORT).show()
            }
    }
