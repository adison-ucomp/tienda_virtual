...
class SpecifySelectActivity : AppCompatActivity() {
    ...
    private fun loadCard(data: SpecifyModel): CardView {
        ...
        val btnEdit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@SpecifySelectActivity, SpecifyUpdateActivity::class.java)
        ...
        val btnQuit = ImageView(this).apply {
            ...
            setOnClickListener {
                val intent = Intent(this@SpecifySelectActivity, SpecifyDeleteActivity::class.java)
                intent.putExtra("register", data.register)
                startActivity(intent)
            }
        }
